...
@if (count($customer_notifications) > 0)
    <div class="read_btn">
        <li class="dropdown-menu-footer" id="all_notification_footer">
            <a class="btn btn-danger mark_read_btn mark_read_btn_danger d-block" href="{{ route('mark.customer.notification') }}"> Mark As Read All Notification </a>
        </li>
        
        
        <li class="dropdown-menu-footer" id="all_notification_footer">
            <a class="btn btn-primary mark_read_btn mark_read_btn_info d-block" href="{{ route('customer_notification.index') }}" style="margin: 20px 20px;"> View All Notification </a>
        </li>
